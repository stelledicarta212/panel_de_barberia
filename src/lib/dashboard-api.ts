...
export function normalizeMergedFromState(raw: DashboardStateResponse): DashboardMerged {
  ...
  return {
    ...
    logo_url: pickFirstText(merged.logo_url, draft["logo_url"], published["logo_url"], seed["logo_url"]),
    cover_url: pickFirstText(merged.cover_url, draft["cover_url"], published["cover_url"], seed["cover_url"]),
